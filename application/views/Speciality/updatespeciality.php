    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-medkit" style="font-size:18px;color:#3c8dbc"></i> Update Speciality</h3>
          </div>
          <form method="post" action="<?php echo base_url()?>Speciality/updatespeciality/<?php echo $speciality_row['id']?>" enctype="multipart/form-data">
        <div class="box-body">
		  ...
		  <div class="col-md-6">
                ...
                <input class="form-control" id="speciality" name="speciality" type="text" placeholder="Enter Speciality"
				 value="<?php echo $speciality_row['speciality']?>" onKeyUp="isalpha(this)">
		  ...
		  <div class="col-md-6">
                ...
                <textarea class="abtspeciality" rows="6" id="abtspeciality" name="abtspeciality" cols="10" placeholder="Enter About Speciality"
				style="width: 100%; font-size: 12px; line-height: 12px; border: 1px solid #dddddd; padding: 10px;"><?php echo $speciality_row['abtspeciality']?></textarea>
