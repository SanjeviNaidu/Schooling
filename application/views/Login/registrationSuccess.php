...
<head>
  ...
  <title>TMT - Registration success</title>
  <!-- Bootstrap core CSS-->
  <!-- Bootstrap core CSS-->
	...
	<div class="card-header">
      ...
      <div class="card-body">
	   <div class="text-center mt-12 mb-12">
		<i class="fa fa-check-circle" style="font-size:40px;color:green"></i><br/>
          <span  style="color:green">Congratulations..! Registration Successful </span>
		  <a class="d-block small mt-2" href="<?php echo base_url()?>Login/index">Click here to Login </a>
         </div>
