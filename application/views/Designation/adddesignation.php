    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-address-card" style="font-size:18px;color:#3c8dbc"></i> Add Designation</h3>
          </div>
          <form method="post" action="<?php echo base_url()?>Designation/adddesignation" enctype="multipart/form-data">
        <div class="box-body">
          <div class="form-group col-sm-12">
		  <div class="col-md-6">
                <label for="designation">Designation</label>
                <input class="form-control" id="designation" name="designation" type="text" placeholder="Enter Designation"
				 value="<?php echo set_value('designation')?>" onKeyUp="isalpha(this)">
